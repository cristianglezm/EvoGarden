...
-   **Eggs** (`🥚`): The offspring of insects. They remain stationary and have a fixed `hatchTimer`. Each tick, the timer decrements. When it reaches zero, the egg is removed and a new insect of the parent's species spawns in its place.
