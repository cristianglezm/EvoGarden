...
export class SimulationEngine {
    ...
    private _calculateTickSummary(nextActorState: Map<string, CellContent>, newFlowerCount: number, tickTimeMs: number): TickSummary {
        ...
        let caterpillarCount = 0, butterflyCount = 0, beetleCount = 0, ladybugCount = 0, snailCount = 0, beeCount = 0;
        ...
        return {
            ...
            caterpillarCount, butterflyCount, beetleCount, ladybugCount, snailCount, beeCount,
